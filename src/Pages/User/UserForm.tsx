...
import { GetChangedFields, RemoveEmptyFields } from "../../Utils/FormHelpers";
...
const UserForm = () => {
  ...
  if (isEditing) {
    const changedFields = GetChangedFields( payload, data ) as Partial<UserFormValues>;
    await editUser(
      {
        ...(payload as UserFormValues),
        ...changedFields,
        userId: data._id,
      },
    ...
    await addUser( RemoveEmptyFields(payload) as UserFormValues, {
        onSuccess: handleSuccess,
      });
  }
};
              ...
              <FormikForm noValidate>
                <AntForm layout="vertical">
                  <Row gutter={[16, 16]}>
                    ...
                    <Col xs={24} sm={12}>
                      <CommonInput name="mobileNumber" label="Mobile Number" placeholder="Enter mobile number" required />
                    </Col>
                    <Col xs={24} sm={12}>
